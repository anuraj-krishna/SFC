...
function MainLayout({ children }) {
    ...
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const { isAuthenticated, isLoading, checkAuth, hasCompletedOnboarding } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MainLayout.useEffect": ()=>{
            ...
            const isProtectedRoute = protectedRoutes.some({
                "MainLayout.useEffect.isProtectedRoute": (route)=>pathname.startsWith(route)
            }["MainLayout.useEffect.isProtectedRoute"]);
            if (isProtectedRoute && !isAuthenticated) {
                router.push(`/login?redirect=${encodeURIComponent(pathname)}`);
                return;
            }
            // Redirect to onboarding if not completed (except if already on onboarding page)
            if (isAuthenticated && !hasCompletedOnboarding && pathname !== "/onboarding" && isProtectedRoute) {
...
_s(MainLayout, "3FgwkOOXGJ7N1pOktdtHxse8fX8=", false, function() {
    return [
...
//# sourceMappingURL=src_0d4e5dde._.js.map